...
Another use of these confidence intervals is to compute their relative width and compare the variance of different measurement methods~\cite{bulej2019initial} as
