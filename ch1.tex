...
\xxx{Can these be combined?}
However, maintaining multiple dedicated machines is difficult and costly \xxx{cite} and that is why much reasearch over the past decade~\cite{leitner2016patterns, laaber2019software, abedi2017conducting} has focused on offloading performance measurements to the cloud.
