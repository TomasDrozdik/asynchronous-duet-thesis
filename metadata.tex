...
A/B benchmarking in variable environments such as the public cloud is difficult.
...
The asynchronous duet method can detect $1-5\%$ slowdowns for most of the tested benchmarks in variable environments while reducing the overall costs by up to $50\%$.
